...
class PlugTablet(Frame):
	def __init__(self,master):
		...
		self.photo = PhotoImage(file="img/plugin.png")
...
class DeleteAppsCheckboxes(Frame):
	def __init__(self, master):
		...
		self.photo = PhotoImage(file="img/delete.png")
...
class Success(Frame):
	def __init__(self,master):
		...
		self.photo = PhotoImage(file="img/AndroidSuccess.png")
...
class Failure(Frame):
	def __init__(self,master):
		...
		self.photo = PhotoImage(file="img/AndroidFailure.png")
...
class GetTemoin(Frame):
	def __init__(self,master):
		...
		self.photo = PhotoImage(file="img/file-transfer.png")
...
class BranchementAutres(Frame):
	def __init__(self,master):
		...
		self.photo = PhotoImage(file="img/multiple.png")
...
class HowMany(Frame):
	def __init__(self,master):
		...
		self.photo = PhotoImage(file="img/androidQuestion.png")
...
class AddAppsFirst(Frame):
	def __init__(self, master):
		...
		self.photo = PhotoImage(file="img/FileUpload.png")
...
class MainMenu(Frame):
	...
	def __init__(self, master):
		...
		self.photo = PhotoImage(file="img/android-logo-png.png")
