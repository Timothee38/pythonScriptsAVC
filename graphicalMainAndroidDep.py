...
class MainMenu(Frame):
    def __init__(self, master):
        ...
        self.texteWifiFirst = Label(self,
                                    text="Note: pour la plupart des applications, veuillez ne brancher\n qu'une seule tablette, sauf contre-indication.",
                                    fg="red").pack(pady=5)
        ...
        self.deleteBtn = Button(self.frame, text="Supprimer des applications", width=20, height=3,
                                command=self.openDelete).pack(side=LEFT, padx=5)

        self.addBtn = Button(self.frame, text="Ajouter des applications", width=20, height=3,
        ...
        self.cloneBtn = Button(self.frameBas, text="Cloner une tablette témoin", width=45, height=3,
